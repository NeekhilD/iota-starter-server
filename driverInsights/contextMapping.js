...
var contextMapping = {
	...
	_getRequestOptions: function (path, queries, base) {
		...
		if (this.contextMappingConfig.tenant_id) {
			...
			if (this.contextMappingConfig.internal_tenant_id !== undefined) {
				qps.internal_tenant_id = this.contextMappingConfig.internal_tenant_id;
			}
